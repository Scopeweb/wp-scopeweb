(function() {
    ...
    function animateOnScroll() {
        ...
        if (jQuery().isotope) {
            jQuery(".load-isotope:not(.loading):not(.disabled) > a[data-method='infiniteload']").filter(function(i, d) {
    ...
    jQuery(window).load(function() {
        if ((jQuery("#logo").hasClass("logo-right") && (jQuery("#hero").hasClass("side-left") || jQuery("#hero").hasClass("side-left-small"))) || (jQuery("#logo").hasClass("logo-left") && (jQuery("#hero").hasClass("side-right") || jQuery("#hero").hasClass("side-right-small")))) {} else {
        ...
        if (jQuery().revolution) {
            ...
            jQuery("#hero .revolution-slider").bind("revolution.slide.onchange", function(e, data) {
                if (data.currentslide.hasClass('text-light')) {
                    ...
                    jQuery("#hero .revolution-slider .scopeweb-nav").addClass("scopeweb-light").removeClass("scopeweb-dark");
                    jQuery("#hero .revolution-slider .scopeweb-bullets").addClass("scopeweb-light").removeClass("scopeweb-dark")
                } else {
                    jQuery("#logo").removeClass("text-light");
                    jQuery("#hero #scrolldown").removeClass("text-light");
                    jQuery("#hero .revolution-slider .scopeweb-nav").addClass("scopeweb-dark").removeClass("scopeweb-light");
                    jQuery("#hero .revolution-slider .scopeweb-bullets").addClass("scopeweb-dark").removeClass("scopeweb-light")
                }
            })
        }
